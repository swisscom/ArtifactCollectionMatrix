...
## Linux live collection tools
  ...
  | [ir-rescue](https://github.com/diogo-fernan/ir-rescue)                                     | :cloud:                      | :cloud:                                                  | :sunny:                 | :sunny:              | :sunny:                                              | :sunny: <br /> (Bash v4+)                                        | :sunny:        | :cloud: <br /> AVML for memory dump                       | :cloud:                                                         | :sunny:                               | :sunny:                                                 | 
